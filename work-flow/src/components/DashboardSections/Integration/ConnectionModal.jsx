  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (platform === 'facebook' || platform === 'instagram') {
        // The OAuth redirect is handled by the button click, so we just close the modal
        onClose();
        return;
      }
      ...
      if (platform === 'whatsapp') {
        // In a real implementation, you would make an API call here to save WhatsApp credentials
        // For now, we'll just simulate success
        console.log('Saving WhatsApp connection data:', { platform, connectionType, ...formData });
      }
      
      onSave({ platform, connectionType, ...formData });
      setIsLoading(false);
    } catch (error) {
